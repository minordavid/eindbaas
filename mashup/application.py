...
# looks up articles, searches for a given place
...
def articles():
    ...
    # if it isnt there give an error
    if not geo:
        raise RuntimeError("no Geo")

    # looks up articles at the geo location
    articles = lookup(geo)

    # retruns a json with max 5 articles
...
def search():
    ...
    # returns json with max 10 places
